...
export default function Page({ searchParams }: FormProps) {
  return (
    <div className="">
      <Header
        title={<span>Não deixe a distância atrapalhar sua conexão com o Brasil e sua família!</span>}
        description={<>Conheça o método simples e prático para garantir passagens mais baratas e viagens mais frequentes.</>}
