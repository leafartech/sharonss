...
export default function Page({ searchParams }: FormProps) {
  return (
    <div className="">
      <Header
        title={<span>Descubra o segredo das companhias aéreas e economize 50% na passagem para o Brasil</span>}
        description={<>Destrave a sua ida para o Brasil economizando 50% em passagens e nunca mais perder momentos especiais.</>}
